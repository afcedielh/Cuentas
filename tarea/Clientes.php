  ...
  <div class="container">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <h2>Mantenimiento <b>Clientes</b></h2>
          </div>
          <div class="col-sm-6">
          ...
          <tr>
            ...
            <td>
              <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                  title="Editar">&#xE254;</i></a>
              <a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                  title="Borrar">&#xE872;</i></a>
            </td>
          </tr>
          <?php  } ?>
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-success" name="Guardar" id="Guardar" value="Agregar">
          </div>
        </form>
        <?php
          if(isset($_POST['Guardar'])){
            echo "<script>alert(' eNTRO')</script>";
              ...
              $insertar = "SET @p0='$Nombre1'; SET @p1='$Cedula1'; SET @p2='Telefono1'; CALL `CrearCliente`(@p0, @p1, @p2);";
              if ($enlace->query($insertar) === TRUE) {
